...
type RecommendationServiceClient interface {
	Index(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *recommendationServiceClient) Index(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/RecommendationService/Index", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRecommendationServiceServer) Index(context.Context, *Request) (*Response, error) {
...
func _RecommendationService_Index_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).Index(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/RecommendationService/Index",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).Index(ctx, req.(*Request))
	}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Index",
			Handler:    _RecommendationService_Index_Handler,
		},
	},
